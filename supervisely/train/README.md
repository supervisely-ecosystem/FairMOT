...
You can use the [import MOT format APP](../../../../supervisely-ecosystem/import-mot-format) to import your [MOT format data](https://motchallenge.net/instructions/) into Supervisely.  
